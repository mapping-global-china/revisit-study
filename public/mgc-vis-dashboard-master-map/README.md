# MGC Master Map Think-Aloud Study

This study captures how participants explore the MGC master map page while thinking aloud.

## Source

- URL: https://mgc-vis.shresthalucky.com.np/dashboard/master
- Source mode: Live-link mode (external tool reached over the network)
- Date scaffolded: 2026-08-21

## Decisions made

- Study goal: Observe how people navigate and interpret the master map page, and where they get stuck or confused during natural exploration.
...
- Study config: `public/mgc-vis-dashboard-master-map/config.json`
- Intro copy: `public/mgc-vis-dashboard-master-map/assets/introduction.md`
- Debrief copy: `public/mgc-vis-dashboard-master-map/assets/debrief.md`

## Running this study

1. Run `yarn serve`.
2. In the study selector, choose `mgc-vis-dashboard-master-map`.
